...
**5. 실험적 검증 결과 (Validation 기준)**
| 모델 | Val Accuracy | Val F1 Macro | 비고 |
|------|--------------|--------------|------|
| **ResNet18** | **83.1%** | **83.4%** | ✅ 채택 |
| ResNet18 + CBAM | 80.1% | 80.7% | 오히려 낮음 |
...
#### 성능 비교 (Validation 기준)
| 모델 | Val Accuracy | Val Macro F1 | 모델 크기 |
|------|--------------|--------------|-----------|
| **ResNet18 (기본)** | **83.1%** | **83.4%** | 46MB |
| ResNet18 + CBAM | 80.1% | 80.7% | 135MB |
...
### 1. 검출 성능
- CT CNN: **83.1% Val Accuracy**, **83.4% Val Macro F1**
